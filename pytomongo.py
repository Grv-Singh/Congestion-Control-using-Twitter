...
WORDS = ['road traffic','รถติด', 'อุบัติเหตุ', 'ถ.', 'ถนน', 'จราจร','รถเยอะ', 'ติดขัด' ,'traffic jam', 'accident', 'rd.', 'road', 'traffic','jam', 'congest']
...
class StreamListener(tweepy.StreamListener):    
    ...
    def on_data(self, data):
        ...
        try:
            ...
            db.keywordcollection.insert(datajson)
...
keyword=streamer.filter(track=WORDS)
keyword.filter(locations=[100.329071, 13.49214,100.938637, 13.95495])